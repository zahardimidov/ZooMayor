  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          'absolute z-[999]',
          orientation === 'horizontal' ? 'left-0 top-1/2 -translate-y-1/2' : 'top-0 left-1/2 -translate-x-1/2',
          className,
        )}
        ...
        {...props}
      >
        <ArrowIcon className="rotate-90 size-[30px]" />
...
const CarouselNext = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof Button>>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        'absolute z-[999]',
        orientation === 'horizontal' ? 'right-0 top-1/2 -translate-y-1/2' : 'bottom-0 left-1/2 -translate-x-1/2 rotate-90',
        className,
      )}
